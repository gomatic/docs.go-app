...
The **public documentation** site for [`gomatic/go-app`](https://github.com/gomatic/go-app). Built from [`nicerobot/template.repo-docs`](https://github.com/nicerobot/template.repo-docs) as a self-contained [Hugo](https://gohugo.io) site, published to GitHub Pages.
